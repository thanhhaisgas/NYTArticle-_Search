# Project 2 - NYTArticle

**NYTArticle** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] User can highlight the interesting article.
* [x] Swipe to refresh articles.

## Video Walkthrough

Here's a walkthrough of implemented user stories:
[Direct link](http://i.imgur.com/QARv8Vz.gifv)
...
Not enough time to complete my app.
